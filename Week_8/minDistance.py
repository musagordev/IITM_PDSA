#Python function takes n points given as a list of tuplse, where each tuple represents point in a 2 dimensional space (x,y).
#Function will return minimum distance between two points in the list.
